...
public class MergeSort_3 {
    ...
    private void sort(int input[], int low, int high){
        //TODO = because we need at least two elements to partition in mergesort
        if(low >= high){
            return;
        }
    ...
    private void sortedMerge(int input[], int low, int high){
        ...
        int j = middle+1;
        int r = 0;
        //TODO remember the while loop here
    ...
    public static void main(String args[]){
        ...
        MergeSort_3 ms = new MergeSort_3();
        ms.sort(input1);
        ms.sort(input2);
        ms.sort(input3);
        ms.sort(input4);
