 ...
 */
public class X_SparseTableRangeMinimumQuery {

    private final int[][] sparse;
    private final int n;
    private final int[] input;

    public X_SparseTableRangeMinimumQuery(int[] input) {
        this.input = input;
        this.n = input.length;
    ...
    public static void main(String args[]) {
        ...
        X_SparseTableRangeMinimumQuery sparseTableRangeMinimumQuery = new X_SparseTableRangeMinimumQuery(input);
        for (int i = 0; i < input.length; i++) {
