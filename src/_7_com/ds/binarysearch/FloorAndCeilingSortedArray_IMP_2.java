 ...
 * Examples :
 * 
 * For example, let the input array be {1, 2, 8, 10, 10, 12, 19} For x = 0:
 * floor doesn't exist in array, ceil = 1 For x = 1: floor = 1, ceil = 1 For x =
 * 5: floor = 2, ceil = 8 For x = 20: floor = 19, ceil doesn't exist in array
 * 
 */
public class FloorAndCeilingSortedArray_IMP_2 {
	...
	public int floor(int input[], int x) {
		...
		while (low <= high) {
			...
			// TODO checking against middle+1
	...
	public static void main(String args[]) {
		...
		FloorAndCeilingSortedArray_IMP_2 foc = new FloorAndCeilingSortedArray_IMP_2();
