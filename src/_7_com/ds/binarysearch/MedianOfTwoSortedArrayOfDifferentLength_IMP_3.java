...
public class MedianOfTwoSortedArrayOfDifferentLength_IMP_3 {
    ...
    public double findMedianSortedArrays(int input1[], int input2[]) {
        //TODO if input1 length is greater than switch them so that input1 is smaller than input2.
        ...
        //TODO remember the low and high of the array
        int low = 0;
        int high = x;
    ...
    public static void main(String[] args) {
        ...
        ///TODO partion between 9 and 15 of x and 11 and 19 of y
        int[] x = {1, 3, 8, 9, 15};
