...
public class IntervalTree_IMP_3 {
    ...
    public InternalNode insert(InternalNode root, int low, int high) {
        ...
        if(low < root.low) {
            //TODO remember the root.left = .....
            root.left = insert(root.left, low, high);
        } else {
            //TODO remember the root.right =.....
            root.right = insert(root.right, low, high);
        }
        //TODO remember to calculate root max
    ...
    public static void main(String args[]) {
        IntervalTree_IMP_3 it = new IntervalTree_IMP_3();
