 ...
 * https://www.youtube.com/watch?v=BEbX2fEl4W0
 */

import java.util.concurrent.atomic.AtomicInteger;

public class PrintPostOrderFromPreOrderInOrder_IMP_3X {
    ...
    public static void main(String args[]) {
        ...
        PrintPostOrderFromPreOrderInOrder_IMP_3X ppp = new PrintPostOrderFromPreOrderInOrder_IMP_3X();
