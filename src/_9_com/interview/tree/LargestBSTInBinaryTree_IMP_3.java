 ...
 */
public class LargestBSTInBinaryTree_IMP_3 {
	...
	private MinMax largest(Node root) {
		...
		// if either of left or right subtree says its not BST or the data of this node
		// is not greater/equal than max of left and less than min of right
		...
		//TODO check root.left is not equal to null, ALSO HERE MIN is left 's min
		m.min = root.left != null ? leftMinMax.min : root.data;

		// if root.right is null then set root.data as max else
		// take max of right side as max.
		//TODO check root right is not equal to null, ALSO HERE MAX is right 's max
	...
	public static void main(String args[]) {
		LargestBSTInBinaryTree_IMP_3 lbi = new LargestBSTInBinaryTree_IMP_3();
