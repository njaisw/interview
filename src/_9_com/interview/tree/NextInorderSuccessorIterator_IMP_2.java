 ...
 * null tree.
 */
public class NextInorderSuccessorIterator_IMP_2 {

	private Node root = null;
	Stack<Node> stack = new Stack<Node>();

	NextInorderSuccessorIterator_IMP_2(Node root) {
		this.root = root;
	}
	...
	public static void main(String args[]) {
		...
		NextInorderSuccessorIterator_IMP_2 nis = new NextInorderSuccessorIterator_IMP_2(node);
		while (nis.hasNext()) {
