 ...
 * 
 */
public class CousinNodes_IMP_3 {
    ...
    public boolean areCousins1(Node root, int data1, int data2) {
        ...
        while (!queue.isEmpty()) {
            while (tempLevel > 0) {
                ...
                if (root.left != null) {
                    if (root.left.data == data1) {
                        ...
                        //TODO check the mode is pushed to queue only when it does not matches
                        queue.add(root.left);
                        level++;
                    }
                }
            ...
            //TODO check found1 and found2 only after entire level is checked
    ...
    public static void main(String args[]) {
        ...
        CousinNodes_IMP_3 cn = new CousinNodes_IMP_3();
