 ...
 */
public class TreeTraversalLevelByLevel_IMP_2 {
    ...
    public void levelByLevelOneQueueUsingDelimiter(Node root) {
        ...
        while (!q.isEmpty()) {
            ...
            if (root != null) {
            	...
            	//TODO remember the else condition
                if (!q.isEmpty()) {
                    System.out.println();
                    q.offer(null);
                }
    ...
    public void levelByLevelOneQueueUsingCount(Node root) {
        ...
        while (!q.isEmpty()) {
            ...
            System.out.println();
            //TODO checkout levelcount and currentcount
    ...
    public static void main(String args[]) {
        TreeTraversalLevelByLevel_IMP_2 tt = new TreeTraversalLevelByLevel_IMP_2();
