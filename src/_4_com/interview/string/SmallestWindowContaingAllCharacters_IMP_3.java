...
public class SmallestWindowContaingAllCharacters_IMP_3 {
    ...
    public String minWindow(String s, String t) {
        ...
        while (i < s.length()) {
            ...
            // TODO Running for each loop , when all the elements are found then start removing junk elements from the begining
            while (currLen == 0) {
    ...
    public static void main(String args[]) {
        ...
        SmallestWindowContaingAllCharacters_IMP_3 swcac = new SmallestWindowContaingAllCharacters_IMP_3();
