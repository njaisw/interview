 ...
 * @ThreadSafe
 */
public class _6_MinMaxKeeper {
    //TODO AtomicInteger instead of normal min and max values
    ...
    /**
     * TODO Threadsafe way of updating min and max
     * @param value
     */
    public void updateMinMax(int value){
        ...
        while(true){
            ...
            //TODO try to update value only if minVal is in min
            //TODO remember logic here compare and set
    ...
    public static void main(String args[]) throws InterruptedException{
        ...
        _6_MinMaxKeeper mmKeeper = new _6_MinMaxKeeper();
    ...
    static class GenerateRand implements Runnable{
        int index = 0;
        _6_MinMaxKeeper mmKeeper;
        public GenerateRand(_6_MinMaxKeeper mmKeeper, int index) {
            this.index = index;
