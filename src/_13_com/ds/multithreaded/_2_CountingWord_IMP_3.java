 ...
 *         Implement two apis 1) void addWord(String word) -> increment count of
 *         this word 2) long getCount(String word) -> get count of this word
 * 
 *         Solution Keep a concurrent map. Key to this map should be word while
 *         value should be AtomicLong to update it in threadsafe way
 * 
 *         Test cases One word updated by many threads Many words updated by
 *         many threads
 *
 * @Threadsafe
 */
public class _2_CountingWord_IMP_3 {
	
	// TODO 1: Concurrent HashMap with AtomicLong
	...
	public static void main(String args[]) throws InterruptedException {
		...
		_2_CountingWord_IMP_3 cw = new _2_CountingWord_IMP_3();
