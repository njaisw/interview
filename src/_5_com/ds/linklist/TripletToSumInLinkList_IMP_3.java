 ...
 * positive sum
 */
public class TripletToSumInLinkList_IMP_3 {

    public void printTriplet(Node head1, Node head2, Node head3,int sum){
        if(head1 == null || head2 == null || head3 == null){
            return;
        }
        //TODO Remember sort only 2 linked list
        //TODO other linkedlist is sorted in reverse order
    ...
    public static void main(String args[]){
        ...
        TripletToSumInLinkList_IMP_3 tts  = new TripletToSumInLinkList_IMP_3();
