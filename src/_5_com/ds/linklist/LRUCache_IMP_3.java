...
//3: TODO The most recently used pages will be near front end (add will happen from the front)and least recently pages will be near rear end(delete will happen from the end)
...
public class LRUCache_IMP_3 {
	...
	public void get(int data) {
		if (containsInCache(data)) {
			...
			//TODO if node is already at head then nothing nees to be done
			if (node != head) {
