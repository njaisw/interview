 ...
 * Here 1,3,6,8 are sorted, 4,5,10 are sorted and 7,9 are sorted
 * Test case
 * null node
 * 1 node
 * 2 sorted nodes
 ...
 */
public class SortNearlySortedList_IMP_3 {
    ...
    public Node sort(Node head){
        ...
        //TODO merge sort remaining elements
        result = mergeSort(result,start);
        return result;
    }
    ...
    public static void main(String args[]){
        ...
        SortNearlySortedList_IMP_3 sns = new SortNearlySortedList_IMP_3();
        head = sns.sort(head);
        ll.printList(head);
    }
}
