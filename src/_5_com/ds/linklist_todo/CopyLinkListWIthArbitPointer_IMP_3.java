 ...
 */
public class CopyLinkListWIthArbitPointer_IMP_3 {
    ...
    public RandomListNode copyRandomList(RandomListNode head) {
        ...
        while (current != null) {
            ...
            clonedNode.random = current.random;
    ...
    public static void main(String args[]){
        ...
        CopyLinkListWIthArbitPointer_IMP_3 cll = new CopyLinkListWIthArbitPointer_IMP_3();
