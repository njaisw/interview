 ...
 */
public class LongestSameSumSpan_IMP_3 {
    ...
    public int longestSpan(int input1[], int input2[]) {
        ...
        int maxSpan = 0;
        //TODO currentDiff for 0
        diff.put(0, -1);
        for (int i = 0; i < input1.length ; i++) {
            prefix1 += input1[i];
            prefix2 += input2[i];
            //TODo difference of prefix sum of the two arrays
    ...
    public static void main(String args[]) {
        ...
        LongestSameSumSpan_IMP_3 lsss = new LongestSameSumSpan_IMP_3();
