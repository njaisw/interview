 ...
 */
public class JumpGame_IMP_3 {

    public boolean canJump(int[] nums) {
        int jump = 0;
        int i;
        //TODO Remembber i<=jump
        for (i = 0; i < nums.length && i <= jump; i++) {
            //TODO jump is max of jump and i+nums[i]
            jump = Math.max(jump, i + nums[i]);
        }

        //TODO check for numlength
    ...
    public static void main(String args[]) {
        JumpGame_IMP_3 jumpGame = new JumpGame_IMP_3();
