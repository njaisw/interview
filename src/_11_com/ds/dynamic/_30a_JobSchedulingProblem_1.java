 ...
 */
//TODO USes Greedy Algo
public class _30a_JobSchedulingProblem_1 {
    ...
    static void printJobScheduling(Job arr[], int n) {
        //TODO Sort all jobs according to decreasing order of profit
        ...
        for (int i = 0; i < n; i++) {
            //TODO  Find a free slot (Note that we start from the last possible slot )
