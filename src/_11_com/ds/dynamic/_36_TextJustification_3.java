 ...
 * one line.
 * 
 * For every range i,j(words from i to j) find the weight of putting them on one line. If words
 * from i to j cannot fit in one line weight will be infinite. Cost is calculated as square of
 ...
 */
public class _36_TextJustification_3 {

    public String justify(String words[], int width) {
        
        int cost[][] = new int[words.length][words.length];
        
        //next 2 for loop is used to calculate weight of putting words from
        ...
        System.out.println("Minimum weight is " + minCost[0]);
        System.out.println("\n");
    ...
    public static void main(String args[]){
        ...
        _36_TextJustification_3 awl = new _36_TextJustification_3();
