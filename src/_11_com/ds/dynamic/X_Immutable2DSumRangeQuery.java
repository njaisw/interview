 ...
 */
public class X_Immutable2DSumRangeQuery {
    private int[][] T;

    public X_Immutable2DSumRangeQuery(int[][] matrix) {
        int row = 0;
        int col = 0;
        if (matrix.length != 0) {
            row = matrix.length;
    ...
    public static void main(String args[]) {
        ...
        X_Immutable2DSumRangeQuery isr = new X_Immutable2DSumRangeQuery(input1);
