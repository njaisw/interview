 ...
 */
public class _16_EditDistance_1 {
    ...
    public void printActualEdits(int T[][], char[] str1, char[] str2) {
        ...
        int j = T[0].length - 1;
        while(true) {
            //todo break when row or colum is zero
            if (i == 0 || j == 0) {
                break;
            }
            if (str1[i-1] == str2[j-1]) {
                //TODO NO edit required
                i = i-1;
                j = j-1;
            } else if (T[i][j] == T[i-1][j-1] + 1){
                //todo Convert as coming from diagonal
    ...
    public static void main(String args[]){
        String str1 = "azced";
        String str2 = "abcdef";
        _16_EditDistance_1 editDistance = new _16_EditDistance_1();
