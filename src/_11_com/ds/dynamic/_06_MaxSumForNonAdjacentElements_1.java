 ...
 */
public class _06_MaxSumForNonAdjacentElements_1 {
    ...
    public static void main(String args[]) {
        _06_MaxSumForNonAdjacentElements_1 msn = new _06_MaxSumForNonAdjacentElements_1();
        int arr[] = { 2, 10, 13, 4, 2, 15, 10 };
        System.out.println(msn.maxSum(arr));
        //s System.out.println(msn.maxSum(arr, arr.length-1));
