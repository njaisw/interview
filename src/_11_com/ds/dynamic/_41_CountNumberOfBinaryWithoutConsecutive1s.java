 ...
 */
public class _41_CountNumberOfBinaryWithoutConsecutive1s {
    ...
    public static void main(String args[]){
        _41_CountNumberOfBinaryWithoutConsecutive1s cnb = new _41_CountNumberOfBinaryWithoutConsecutive1s();
