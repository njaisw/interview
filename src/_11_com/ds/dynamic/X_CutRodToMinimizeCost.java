 ...
 * @author Tushar Roy
 *
 * Given a rod with markings. Cut the rod along markings but reduce the weight of cutting.
 * Cost if cutting is proportional to the length of rod being cut.
 *
 * Solve is using top down dynamic programming. Memoize minimum weight of cutting between marking
 * start to end. To calculate the value try all markings b/w start to end.
 *
 */
public class X_CutRodToMinimizeCost {
    ...
    public static void main(String args[]) {
        ...
        X_CutRodToMinimizeCost cr = new X_CutRodToMinimizeCost();
