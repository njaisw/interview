...
import _6_com.ds.stackqueue.MaximumHistogram_IMP_3;
 ...
 */
public class _23_MaximumRectangularSubmatrixOf1s_1 {

    public int maximum(int input[][]){
        int temp[] = new int[input[0].length];
        MaximumHistogram_IMP_3 mh = new MaximumHistogram_IMP_3();
        int maxArea = 0;
        int area = 0;
    ...
    public static void main(String args[]){
        int input[][] = {{1,1,1,0},
                         ...
                         {1,0,0,1},
                         {1,1,1,1}};
        _23_MaximumRectangularSubmatrixOf1s_1 mrs = new _23_MaximumRectangularSubmatrixOf1s_1();
