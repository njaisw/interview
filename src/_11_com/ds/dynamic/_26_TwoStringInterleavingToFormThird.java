 ...
 */
public class _26_TwoStringInterleavingToFormThird {
        ...
        for(int i=0; i < T.length; i++){
            for(int j=0; j < T[i].length; j++){
                ...
                if(i == 0 && j == 0){
                    ...
                    // For the 1st Row, the value evaluates to the previous column if the strings are equal
                    if(str3[l] == str2[j-1]){
                        T[i][j] = T[i][j-1];
                    }
                }
                //For the 1st column the value evalutes to the previous row if the strings are equal
                else if(j == 0){
                    if(str1[i-1] == str3[l]){
                        T[i][j] = T[i-1][j];
                    }
    ...
    public static void main(String args[]){
        ...
        _26_TwoStringInterleavingToFormThird sti = new _26_TwoStringInterleavingToFormThird();
