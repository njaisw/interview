 ...
 */
public class _18_FloydWarshallAllPairShortestPath {
    ...
    public int[][] allPairShortestPath(int[][] inputMatrix) {
        
        int distance[][] = new int[inputMatrix.length][inputMatrix.length];
        int path[][] = new int[inputMatrix.length][inputMatrix.length];
            ...
            for(int i=0; i < inputMatrix.length; i++){
                for(int j=0; j < inputMatrix.length; j++){
                    ...
                    if(distance[i][j] > distance[i][k] + distance[k][j]){
                        ...
                        //TODO Remember the path allocation
                        // path i gets convert to k,j
                        path[i][j] = path[k][j];
                    }
                }
            }
   ...
   //TODO Important printing paths
    ...
    public static void main(String args[]){
        ...
        _18_FloydWarshallAllPairShortestPath shortestPath = new _18_FloydWarshallAllPairShortestPath();
