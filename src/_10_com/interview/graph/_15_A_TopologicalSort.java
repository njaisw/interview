 ...
 */
public class _15_A_TopologicalSort<T> {

    /**
     * Main method to be invoked to do topological sorting.
     */
    public Deque<Vertex<T>> topSort(_1_Graph<T> graph) {

        //TODO Use Deque and ArrayDeque for stack
    ...
    public static void main(String args[]){
        ...
        _15_A_TopologicalSort<Integer> sort = new _15_A_TopologicalSort<Integer>();
