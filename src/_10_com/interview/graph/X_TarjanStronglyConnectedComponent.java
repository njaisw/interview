 ...
 */
public class X_TarjanStronglyConnectedComponent {
    ...
    public static void main(String args[]) {
        ...
        X_TarjanStronglyConnectedComponent tarjanStronglyConnectedComponent = new X_TarjanStronglyConnectedComponent();
