 ...
 */
public class X_AllCyclesInDirectedGraphTarjan {
    ...
    public X_AllCyclesInDirectedGraphTarjan() {
        reset();
    }
    ...
    public List<List<Vertex<Integer>>> findAllSimpleCycles(_1_Graph<Integer> graph) {
        reset();
    ...
    public static void main(String args[]) {
        ...
        X_AllCyclesInDirectedGraphTarjan tarjan = new X_AllCyclesInDirectedGraphTarjan();
