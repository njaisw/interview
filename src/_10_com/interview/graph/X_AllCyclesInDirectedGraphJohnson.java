 ...
 */
public class X_AllCyclesInDirectedGraphJohnson {
     ...
     */
    public List<List<Vertex<Integer>>> simpleCyles(_1_Graph<Integer> graph) {
        ...
        long startIndex = 1;
        X_TarjanStronglyConnectedComponent tarjan = new X_TarjanStronglyConnectedComponent();
        while(startIndex <= graph.getAllVertex().size()) {
            _1_Graph<Integer> subGraph = createSubGraph(startIndex, graph);
   ...
   private Optional<Vertex<Integer>> leastIndexSCC(List<Set<Vertex<Integer>>> sccs, _1_Graph<Integer> subGraph) {
        ...
        _1_Graph<Integer> graphScc = new _1_Graph<>(true);
    ...
    private _1_Graph createSubGraph(long startVertex, _1_Graph<Integer> graph) {
        _1_Graph<Integer> subGraph = new _1_Graph<>(true);
    ...
    public static void main(String args[]) {
        X_AllCyclesInDirectedGraphJohnson johnson = new X_AllCyclesInDirectedGraphJohnson();
