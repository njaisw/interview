 ...
 */
public class _23_PrintAllPathFromSourceToDestination {

    public void printPath(_1_Graph<Integer> graph, Vertex<Integer> start, Vertex<Integer> destination){
    ...
    public static void main(String args[]){
        ...
        _23_PrintAllPathFromSourceToDestination pap = new _23_PrintAllPathFromSourceToDestination();
