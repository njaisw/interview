...
public class _3e_BellmanFordShortestPath {
    ...
    public Map<Vertex<Integer>, Integer> getShortestPath(_1_Graph<Integer> graph,
                                                         Vertex<Integer> sourceVertex) {

       //TODO similar to dikhastra it has both distance and parrent map but not heap
        //TODO Bellmanford does not use BinaryHeap
        Map<Vertex<Integer>, Integer> distance = new HashMap<>();
        Map<Vertex<Integer>, Vertex<Integer>> parent = new HashMap<>();

        //TODO set distance of every vertex to be infinity initially
        for(Vertex<Integer> v : graph.getAllVertex()) {
            distance.put(v, INFINITY);
            parent.put(v, null);
        }

        //TODO set distance of source vertex to be 0
         ...
         */
        //TODO Relax all the edges of the graph v-1 times
        for (int i = 0; i < V - 1 ; i++) {
            //TODO relax of the egges of the graph v-1 times
    ...
    public static void main(String args[]){
        ...
        _3e_BellmanFordShortestPath shortestPath = new _3e_BellmanFordShortestPath();
